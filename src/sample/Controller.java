...
public class Controller {
    ...
    public void ListerRepertoire() {
        if (cb.getValue().equals("Java - Wikitext")) {
            File repertoire = new File("./output/outputJava/wikitext");
            ...
            cb2.setItems(list1);
        } else if (cb.getValue().equals("Java - HTML")){
            File repertoire = new File("./output/outputJava/html");
            ObservableList list1 = FXCollections.observableArrayList();
            String liste[] = repertoire.list();
            ...
            File repertoire = new File("./output/outputPy/");
            ObservableList list1 = FXCollections.observableArrayList();
            String liste[] = repertoire.list();
    ...
    public void displayExtractedFile() throws IOException {
        String extractor = cb.getValue();
        String url = goodUrl.getText();
        String dir = System.getProperty("user.dir") + "/output/outputPy/";
        ...
        String path = dir + name + nb_file +".csv";
    ...
    private void extraction(String url, String format) {
        ...
        try {
            Process process;
            if (format.equalsIgnoreCase("python")) {
    ...
    public void displayCSV() {
        String path;
        if (cb.getValue().equalsIgnoreCase("Java - Wikitext")) {
            path = System.getProperty("user.dir")+"/output/outputJava/wikitext/";
        }
        else if (cb.getValue().equalsIgnoreCase("Java - HTML")) {
            path = System.getProperty("user.dir")+"/output/outputJava/html/";
        } else {
            path = System.getProperty("user.dir")+"/output/outputPy/";
        }
